...
export const FetchBranch = async () => {
  ...
  `;
    ...
    logToFile(userId, "GET branch data", ipAddress, url);
...
export const FetchBranchById = async (branch_id) => {
  ...
  `;
    ...
    logToFile(userId, "GET branch data By Id", ipAddress, url);
...
export const CreateBranch = async ({ formData }) => {
    const FormSchema = z.object({
        ...
        branch_create_by: z.coerce.number().min(1, { message: "กรุณาระบุ ผู้ดำเนินการ" }),
    });
...
export const UpdateBranch = async ({ formData, branch_id }) => {
    const FormSchema = z.object({
        branch_name: z.coerce.string().min(1, { message: "กรุณาระบุ สาขา" }),
        branch_update_by: z.coerce.number().min(1, { message: "กรุณาระบุ ผู้ดำเนินการ" }),
    });
